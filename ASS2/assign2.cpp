...
assign2_exception::exception splay(BST *bst, tree_node *node)
{
    ...
    if (node->data < bst->root->data) {
        ...
        if (node->data < bst->root->l_child->data) {
            BST* new_bst = new BST;
            new_bst->comp = bst->comp;
        ...
        else if (node->data > bst->root->l_child->data){
            BST* new_bst = new BST;
            new_bst->comp = bst->comp;
        ...
        if (node->data < bst->root->r_child->data) {
            BST* new_bst = new BST;
            new_bst->comp = bst->comp;
        ...
        else if (node->data > bst->root->r_child->data){
            BST* new_bst = new BST;
            new_bst->comp = bst->comp;
